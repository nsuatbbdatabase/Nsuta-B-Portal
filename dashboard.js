// Legacy inline teacher helper removed — the teacher form submit and responsibility
// handling are implemented later in this file (centralized in a single submit handler).
